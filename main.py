...
def run_hello_google():
    ...
    if 'to mahi' in command:
        ...
        talk('mahi is a playboy. He loves ,Oorin. sometimes he fall in love with any girl. He jerks all the time. He also jumps all the time.')
        ...
        talk('faiaz sokal is a student of i,u,b. . he is a computer engineer  , he is a handsome boy, and a niqas pussy')
